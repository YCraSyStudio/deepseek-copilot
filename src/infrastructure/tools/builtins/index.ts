...
export const BUILT_IN_TOOLS: RegisteredTool[] = [
  ...
  { definition: createFileDefinition, handler: createFileHandler, forcedHandler: createFileHandlerForced, metadata: createFileMetadata },
  { definition: editFileDefinition, handler: editFileHandler, forcedHandler: editFileHandlerForced, metadata: editFileMetadata },
  { definition: applyPatchDefinition, handler: applyPatchHandler, forcedHandler: applyPatchHandlerForced, metadata: applyPatchMetadata },
  { definition: terminalCommandDefinition, handler: terminalCommandHandler, forcedHandler: terminalCommandHandlerForced, metadata: terminalCommandMetadata },
];
