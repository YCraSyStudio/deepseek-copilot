...
export class ChatHandler {
  ...
  constructor(
    ...
    const webConfig = (): vscode.WorkspaceConfiguration => vscode.workspace.getConfiguration("yrs-dpsk-copilot.webSearch");
    for (const tool of createHeadlessWebTools(this.headlessWebRuntime, {
      configuredEngine: () => webConfig().get<string>("engine"),
      configuredLocale: () => webConfig().get<string>("locale"),
