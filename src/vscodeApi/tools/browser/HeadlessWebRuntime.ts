...
export class HeadlessWebRuntime {
  ...
  constructor(
    private readonly browserManager: Pick<BrowserManager, "resolve" | "getDiagnostics">,
  ) {}
  ...
  async search(
    ...
    return this.navigate(
      ...
      signal,
      true,
      (page, target) => this.performSearch(page, target, query, provider, locale),
    );
  }
