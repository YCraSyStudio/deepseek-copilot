...
| --- | --- | --- | --- | --- | --- |
| 002 | P0 | Serialize generations and isolate conversation transitions | `002-p0-serialize-generations.md` | BUG, INTEGRATION, FRONTEND | — |
...
| 006 | P0 | Preserve protocol-valid DeepSeek tool transcripts | `006-p0-preserve-deepseek-tool-transcripts.md` | BUG, INTEGRATION | 002 |
...
| 008 | P0 | Make disabled history truly ephemeral | `008-p0-make-disabled-history-ephemeral.md` | BUG, INTEGRATION, FRONTEND | 002 |
| 009 | P1 | Guarantee tool-call identity, terminal states, and auditability | `009-p1-tool-call-integrity-and-audit.md` | BUG, INTEGRATION, FRONTEND | 002, 006 |
...
| 012 | P1 | Harden streaming timeouts, bounds, and partial-response recovery | `012-p1-harden-streaming-resilience.md` | BUG, INTEGRATION, FRONTEND | 002, 006 |
| 013 | P1 | Guarantee child-process shutdown on timeout and cancellation | `013-p1-guarantee-process-shutdown.md` | BUG, INTEGRATION | 002 |
| 014 | P1 | Version and synchronize the webview-host protocol | `014-p1-version-webview-host-protocol.md` | BUG, INTEGRATION, FRONTEND | 002, 005, 008 |
...
```powershell
Get-Content -LiteralPath ".github/issue-bodies/002-p0-serialize-generations.md"
```

## Create one issue with GitHub CLI

Example for issue 002:

```powershell
gh issue create `
  --repo "YarCrasy/deepseek-copilot" `
  --title "[P0] Serialize generations and isolate conversation transitions" `
  --label "BUG" `
  --label "INTEGRATION" `
  --label "FRONTEND" `
  --body-file ".github/issue-bodies/002-p0-serialize-generations.md"
```
